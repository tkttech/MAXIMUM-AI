...
const botname = process.env.BOTNAME || 'MAXIMUM-AI';
const antibot = process.env.ANTIBOT || 'FALSE';
   ...
   const quoted = (fatkuns.mtype == 'buttonsMessage') ? fatkuns[Object.keys(fatkuns)[1]] : (fatkuns.mtype == 'templateMessage') ? fatkuns.hydratedTemplate[Object.keys(fatkuns.hydratedTemplate)[1]] : (fatkuns.mtype == 'product') ? fatkuns[Object.keys(fatkuns)[0]] : m.quoted ? m.quoted : m;
    ...
    const author = process.env.STICKER_AUTHOR ||'𝐓𝐊𝐓-𝐓𝐞𝐜𝐡';
    const packname = process.env.STICKER_PACKNAME || '𝐓𝐊𝐓';
const dev = process.env.DEV || '263718095555';
const menu = process.env.MENU_TYPE || 'VIDEO';
 const DevDreaded = dev.split(",");
   ...
   const bad = process.env.BAD_WORD || 'fuck';
    ...
    const thum = fs.readFileSync ('./𝐌𝐀𝐗𝐈𝐌𝐔𝐌_𝐀𝐈.jpg');	  
    const Owner = DevDreaded.map((v) => v.replace(/[^0-9]/g, "") + "@s.whatsapp.net").includes(m.sender);
    const viewOnceMessage = args.join(" ");
    const fcontact = { key: {fromMe: false,participant: `0@s.whatsapp.net`, ...(from ? { remoteJid: "status@broadcast" } : {}) }, message: { 'contactMessage': { 'displayName': `𝙸 𝚊𝚖 𝐓𝐊𝐓-𝐓𝐄𝐂𝐇`, 'vcard': `BEGIN:VCARD\nVERSION:3.0\nN:XL;𝙱𝚎𝚕𝚝𝚊𝚑Bot,;;;\nFN:${pushname},\nitem1.TEL;waid=${sender.split('@')[0]}:${sender.split('@')[0]}\nitem1.X-ABLabel:Ponsel\nEND:VCARD`, 'jpegThumbnail': { url: 'https://telegra.ph/file/00c44dbca471eff754425.png' }}}}
       // Group
...
var lod = [
"i am MAXIMUM-AI",
"cloned by Tafadzwa TKT🇿🇼",
"follow the below steps to deploy me",
"Contact owner after deploying",
	"┣❏𝙷𝚎𝚕𝚕𝚘 𝐢𝐟 𝐲𝐨𝐮 𝐡𝐚𝐯𝐞 𝐞𝐜𝐨𝐜𝐚𝐬𝐡,𝐩𝐚𝐲 𝐨𝐧 +2637777104765 𝐭𝐡𝐞𝐧 𝐬𝐞𝐧𝐝 𝐬𝐜𝐫𝐞𝐞𝐧𝐬𝐡𝐨𝐭\n┣❏[𝐟𝐨𝐥𝐥𝐨𝐰 𝐦𝐲 𝐜𝐡𝐚𝐧𝐧𝐞𝐥 𝐭𝐨 𝐠𝐞𝐭 𝐮𝐩𝐝𝐚𝐭𝐞𝐬]\n┣❏ https://whatsapp.com/channel/0029Vb5vbMM0LKZJi9k4ED1a\n┣❏𝐚𝐥𝐬𝐨 𝐣𝐨𝐢𝐧 𝐨𝐮𝐫 𝐨𝐟𝐟𝐢𝐜𝐢𝐚𝐥 𝐠𝐫𝐨𝐮𝐩\n┣❏https://chat.whatsapp.com/Hn0CUUsl6SM4q0RRKdNM2c\n┣❏𝙰𝚕𝚕 𝚝𝚑𝚊𝚗𝚔𝚜 𝚝𝚘 𝐭𝐤𝐭-𝐭𝐞𝐜𝐡𝐳𝐰🙏😎."
]
let { key } = await client.sendMessage(from, {text: '𝐈 𝐚𝐦 𝐌𝐀𝐗𝐈𝐌𝐔𝐌-𝐀𝐈-𝐁𝐎𝐓'})
...
"type .sc to access my source code",
	"𝐓𝐡𝐚𝐧𝐤 𝐘𝐨𝐮 𝐅𝐨𝐫 𝐖𝐚𝐢𝐭𝐢𝐧𝐠 😁\n\n┣❏𝚃𝚄𝚃𝙾𝚁𝙸𝙰𝙻 𝚅𝙸𝙳𝙴𝙾 𝙵𝙾𝚁 𝙳𝙴𝙿𝙻𝙾𝚈𝙸𝙽𝙶 𝚃𝙷𝙸𝚂 𝙱𝙾𝚃 𝙸𝚂 𝙽𝙾𝚃 𝚈𝙴𝚃 𝙰𝚅𝙰𝙸𝙻𝙰𝙱𝙻𝙴....\n\n┣❏🙂‍↕𝙰𝚜𝚔 tkt-tech 𝚝𝚘 𝚑𝚎𝚕𝚙 𝚢𝚘𝚞 𝚒𝚗 𝚍𝚎𝚙𝚕𝚘𝚢𝚖𝚎𝚗𝚝🙂‍↔ "
]
let { key } = await client.sendMessage(from, {text: '𝐈 𝐚𝐦 𝐌𝐀𝐗𝐈𝐌𝐔𝐌-𝐀𝐈'})
...
"100%",
"𝙸 𝚊𝚖 𝙼𝚊𝚡𝚒𝚖𝚞𝚖-𝙰𝙸🤯",
	" 🙂‍↕𝙼𝙰𝚇𝙸𝙼𝚄𝙼-𝙰𝙸 𝚙𝚒𝚗𝚐𝚒𝚗𝚐 𝚒𝚗 𝚊 𝚏𝚎𝚠🙂‍↔◍ ◉ ⭗"
]
let { key } = await client.sendMessage(from, {text: '📡𝙼𝙰𝚇𝙸𝙼𝚄𝙼 𝙿𝚘𝚗𝚐 𝙻𝚊𝚝𝚎𝚗𝚌𝚢'})
...
"𝙸 𝚊𝚖 𝙼𝙰𝚇𝙸𝙼𝚄𝙼-𝙰𝙸",
            "🗿",	
"🙂‍↕𝙻𝚘𝚊𝚍𝚎𝚍 𝚜𝚞𝚌𝚌𝚎𝚜𝚜𝚏𝚞𝚕𝚕𝚢 𝚋𝚢 𝚃𝙺𝚃-𝚃𝙴𝙲𝙷263🙂‍↔"
]
let { key } = await client.sendMessage(from, {text: '🙂‍↕𝙻𝚘𝚊𝚍𝚎𝚍 𝚜𝚞𝚌𝚌𝚎𝚜𝚜𝚏𝚞𝚕𝚕𝚢 𝚋𝚢 𝙼𝙰𝚇𝙸𝙼𝚄𝙼-𝙰𝙸263🙂‍↔'})
...
if (badwordkick === 'TRUE' && isBotAdmin && !isAdmin && body && (new RegExp('\\b' + badword.join('\\b|\\b') + '\\b')).test(body.toLowerCase())) {
 ...
 client.sendMessage(m.chat, {text:`Adiós:\n\n@${kid.split("@")[0]},𝙼𝙰𝚇𝙸𝙼𝚄𝙼-𝙰𝙸 prohibited sending group links here!`, contextInfo:{mentionedJid:[kid]}}, {quoted:m}); 
       }   
...
if (antilink === 'TRUE' && antilinkall === 'TRUE' && body.includes('http') && !Owner && isBotAdmin && !isAdmin && m.isGroup) { 
 ...
 client.sendMessage(m.chat, {text:`Auf wiedersehen:\n\n@${ki.split("@")[0]}, sending links is prohibited in this group!`, contextInfo:{mentionedJid:[ki]}}, {quoted:m}); 
    ...
    if (cmd && !m.isGroup) {
      console.log(chalk.black(chalk.bgWhite("[MAXIMUM-AI ]")), color(argsLog, "turquoise"), chalk.magenta("From"), chalk.green(pushname), chalk.yellow(`[ ${m.sender.replace("@s.whatsapp.net", "")} ]`));
...
┃⭓│
┃⭓╰┅┅┅┅┅┅┅┅┅┅┅┅┅┅┅⏣
┃➠made ♡᭄ ࣩࣧࣧby ♻️𝐓𝐊𝐓-𝐓𝐞𝐜𝐡♻️▓▒ 
╰════════════════⊷⏣`;

if (menu === 'VIDEO') {

                   client.sendMessage(m.chat, {
                        video: fs.readFileSync('./drexr3-ai menu.mp4'),
                        caption: cap,
                        gifPlayback: true
                    }, {
                        quoted: fcontact
...
client.sendMessage(m.chat, { image: { url: 'https://files.catbox.moe/oxx8ek.jpg' }, caption: cap, fileLength: "9999999999"}, { quoted: fcontact })
} else if (menu === 'LINK') {
client.sendMessage(m.chat, {
                        text: cap,
                        contextInfo: {
                            externalAdReply: {
                                ...
                                sourceUrl: 'https://wa.me/253718095555?text=ʜᴇʟʟᴏ+TKT-TECH™𝕏+ndisoterei+Bot+Mukuru+🥲',
                                mediaType: 1,
...
case "p": case "t": {
	await loadings ()
for (let i = 0; i < 5; i++) {
  m.reply(`📡𝙼𝙰𝚇𝙸𝙼𝚄𝙼-𝙰𝙸 𝙿𝚘𝚗𝚐 𝙻𝚊𝚝𝚎𝚗𝚌𝚢!\n *${dreadedspeed.toFixed(4)}* MS`);
  }
} 
break;
    ...
    if (fileSizeInMegabytes <= 40) {
      await client.sendMessage(
        from, {
          ...
          mimetype: "audio/mpeg",
          caption: "𝚙𝚘𝚠𝚎𝚛𝚎𝚍 𝚋𝚢 |𝙱𝚘𝚝 𝚃𝙺𝚃-𝚃𝙴𝙲𝙷@2025™"
        }, {
          quoted: fcontact
        }
      );
...
let xf = m.quoted.text;
                ...
                let pppuser = await client.profilePictureUrl(m.sender, 'image').catch(_ => 'https://files.catbox.moe/oxx8ek.jpg')
...
case 'restart':  case 'reboot':
  ...
  reply(`♻️𝐌𝐀𝐗𝐈𝐌𝐔𝐌-𝐀𝐈♻️ is Restarting. . .`)  
  await sleep(3000)  
  process.exit()  
  break;
...
await m.reply('𝐑𝐞𝐦𝐨𝐯𝐞𝐝 𝐬𝐮𝐜𝐜𝐞𝐬𝐬𝐟𝐮𝐥𝐥𝐲 𝐛𝐲 ♻️𝐌𝐀𝐗𝐈𝐌𝐔𝐌-𝐀𝐈♻️😬'); 
} catch (errr) { 
 ...
 client.sendMessage(m.chat, { image: { url: `https://files.catbox.moe/oxx8ek.jpg` }, caption: 
`▬▭▬▭▬▭▬▭▬▬▭▬▭▬▬▭▬\n┣❏Hello *${pushname}*▬▭▬▭▬▭▬▭▬▬▭▬▭▬▬▭▬\n\n┣❏𝚈𝚘𝚞 𝚌𝚊𝚗 𝚍𝚎𝚙𝚕𝚘𝚢 𝐁𝐞𝐥𝐭𝐚𝐡-𝐓𝐞𝐜𝐡-𝐁𝐎𝐓 𝚞𝚜𝚒𝚗𝚐 𝚝𝚑𝚎 𝙶𝚒𝚝𝙷𝚞𝚋 𝚕𝚒𝚗𝚔 𝚋𝚎𝚕𝚘𝚠🗿\n\n┣❏𝙵𝚘𝚛𝚔 𝚊𝚗𝚍 𝚐𝚒𝚟𝚎 𝚞𝚜 𝚊 𝚜𝚝𝚊𝚛✨.\n┣❏https://github.com/tkttech/MAXIMUM-AI\n\n┣❏𝙴𝚗𝚓𝚘𝚢 𝚊𝚗𝚍 𝚑𝚊𝚟𝚎 𝚏𝚞𝚗 𝚠𝚒𝚝𝚑 𝚝𝚑𝚎 𝚋𝚘𝚝🗿...\n\n┣❏\n┣❏𝚃𝚄𝚃𝙾𝚁𝙸𝙰𝙻 𝚅𝙸𝙳𝙴𝙾 𝙵𝙾𝚁 𝙳𝙴𝙿𝙻𝙾𝚈𝙸𝙽𝙶 𝚃𝙷𝙸𝚂 𝙱𝙾𝚃 𝙸𝚂 𝙽𝙾𝚃 𝚈𝙴𝚃 𝙰𝚅𝙰𝙸𝙻𝙰𝙱𝙻𝙴.\n┣❏🙂‍↕𝙰𝚜𝚔 TAFADZWA 𝚝𝚘 𝚑𝚎𝚕𝚙 𝚢𝚘𝚞 𝚒𝚗 𝚍𝚎𝚙𝚕𝚘𝚢𝚖𝚎𝚗𝚝🙂‍↔\n┣❏𝙸 𝚊𝚖 𝙼𝙰𝚇𝙸𝙼𝚄𝙼-𝙰𝙸 [wa.me/263718095555]\n┣❏𝙵𝚘𝚕𝚕𝚘𝚠 𝚖𝚢 𝚌𝚑𝚊𝚗𝚗𝚎𝚕 𝚏𝚘𝚛 𝚞𝚙𝚍𝚊𝚝𝚎𝚜 𝚊𝚗𝚍 𝚌𝚘𝚘𝚕 𝚜𝚝𝚊𝚏𝚏 𝚘𝚗 [𝙰𝙸]\n┣❏[https://whatsapp.com/channel/0029Vb5vbMM0LKZJi9k4ED1a]\n\n\n𝙼𝚊𝚍𝚎 𝚘𝚗 𝚎𝚊𝚛𝚝𝚑 𝚋𝚢 𝚃𝙰𝙵𝙰𝙳𝚉𝚆𝙰-𝚃𝙺𝚃\n▬▭▬▭▬▭▬▭▬▬▭▬▭▬▬▭▬` });
 ...
 m.reply('Group successfully locked by ♻️𝐌𝐀𝐗𝐈𝐌𝐔𝐌-𝐀𝐈'♻️!'); 
 } 
 break; 
 ...
 m.reply('Group successfully unlocked by ♻️𝐌𝐀𝐗𝐈𝐌𝐔𝐌-𝐀𝐈♻️!'); 
 ...
 m.reply('  𝐂𝐫𝐨𝐰𝐧𝐞𝐝 𝐬𝐮𝐜𝐜𝐞𝐬𝐬𝐟𝐮𝐥𝐥𝐲 by ♻️𝐌𝐀𝐗𝐈𝐌𝐔𝐌-𝐓𝐄𝐂𝐇♻️! 👑'); 
         } 
 break; 
 case "demote": { 
                 if (!m.isGroup) throw group; 
 ...
 m.reply('Group name successfully updated by ♻️𝐌𝐀𝐗𝐈𝐌𝐔𝐌-𝐀𝐈♻️! 👍'); 
             } 
             break; 
 ...
 m.reply('Group description successfully updated by ♻️𝐌𝐀𝐗𝐈𝐌𝐔𝐌-𝐀𝐈! 👍'); 
             } 
 break; 
 case "hidetag": { 
             if (!m.isGroup) throw group; 
...
break
  case 'play':
    case 'play2': {
        if (!text) {
            reply('𝐏𝐫𝐨𝐯𝐢𝐝𝐞 𝐚 𝐬𝐞𝐚𝐫𝐜𝐡 𝐭𝐞𝐫𝐦!\n𝐄.𝐠: 𝙿𝚕𝚊𝚢 𝐩𝐥𝐚𝐲 𝐕𝐨𝐥𝐭𝐳 𝐦𝐮𝐤𝐨𝐦𝐚 𝐛𝐫𝐢𝐚𝐧')
            return;
        }
        try {
            const {
			...
			caption: "𝐆𝐄𝐍𝐄𝐑𝐀𝐓𝐄𝐃 by 𝐓𝐚𝐟𝐚𝐝𝐳𝐰𝐚-𝐓𝐊𝐓",    
                    }, {
                        quoted: fcontact 
                    }
                );
            ...
            if (fileSizeInMegabytes <= 40) {
                ...
                await client.sendMessage(
                    from, {
                        ...
                        mimetype: "audio/mpeg",
                        fileName: titleYt + ".mp3",
			caption:"𝐩𝐨𝐰𝐞𝐫𝐞𝐝? 𝐛𝐲| 𝐓𝐊𝐓-𝐓𝐄𝐂𝐇@2025™",
                    }, {
                        quoted: fcontact
                    }
                );
...
case "bot": 
	...
	await load ()
                 client.sendMessage(m.chat, { video: { url: 'https://telegra.ph/file/d0332c01f0dd8c3381dc0.mp4' }, caption: `▔▔▔▔▔╠ ⛥𝗕𝗢𝗧 𝗜𝗡𝗙𝗢⛥ ╣▔▔▔▔▔\n◉𝐂𝐫𝐞𝐚𝐭𝐨𝐫 𝐍𝐚𝐦𝐞 : *ꪶ ࣩࣩࣩࣩ᪵᪵᪵᪵᪵ࣧࣧ♻️𝐌𝐀𝐗𝐈𝐌𝐔𝐌-𝐀𝐈♻️\n◎𝐂𝐫𝐞𝐚𝐭𝐨𝐫 𝐍𝐮𝐦𝐛𝐞𝐫 : *wa.me/263718095555*\n◉𝐁𝐨𝐭 𝐆𝐫𝐨𝐮𝐩 : *♻️𝐌𝐀𝐗𝐈𝐌𝐔𝐌-𝐀𝐈♻️𝐁𝐎𝐓*\n◎𝐒𝐩𝐞𝐞𝐝 : *${dreadedspeed.toFixed(4)}* 𝐌𝐬\n◉𝐔𝐬𝐞𝐫 : ${m.pushName}\n◎𝐁𝐨𝐭 𝐕𝐞𝐫𝐬𝐢𝐨𝐧 : *1.0.1*\n◉𝐁𝐨𝐭 𝐍𝐚𝐦𝐞 : ♻️𝐌𝐀𝐗𝐈𝐌𝐔𝐌-𝐀𝐈♻️𝐁𝐎𝐓\n◎𝐏𝐫𝐞𝐟𝐢𝐱 : ${prefix}\n◉𝐓𝐲𝐩𝐞 𝐁𝐚𝐲𝐥𝐢𝐞𝐬 : 𝗖𝗮𝘀𝗲\n◎𝐒𝐨𝐮𝐫𝐜𝐞 𝐂𝐨𝐝𝐞 : *github.com/Fortunatusmokaya/MAXIMUM-GPT-AI*\n◉𝐔𝐩𝐭𝐢𝐦𝐞 : ⏳ *${runtime(process.uptime())}*\n\n▭▬▭▬▭▬▭▬▭▬▭▬▭▬▬▭\n    ⭓𝐏𝐨𝐰𝐞𝐫𝐞𝐝 𝐁𝐲 𝐓𝐊𝐓-𝐓𝐄𝐂𝐇⬣\n▬▭▬▭▬▭▬▭▬▭▬▭▬▬▭▬`,gifPlayback: true }, { quoted: fcontact });
...
case "ping": case "speed": { 
	...
	await loadings ()
m.reply (`📡𝐌𝐚𝐱𝐢𝐦𝐮𝐦 𝙿𝚘𝚗𝚐 𝙻𝚊𝚝𝚎𝚗𝚌𝚢! *${dreadedspeed.toFixed(4)}* 𝐌𝐬`);
   } 
 break; 
  
 case "runtime": case "uptime": { 
                 client.sendMessage(m.chat, { video: { url: 'https://telegra.ph/file/a91218a98b91ec37fac81.mp4' }, caption: `┣❏𝐌𝐀𝐗𝐈𝐌𝐔𝐌-𝐀𝐈-𝐁𝐎𝐓 𝙷𝚊𝚜 𝙱𝚎𝚎𝚗 𝙰𝚌𝚝𝚒𝚟𝚎 𝙵𝚘𝚛\n┣❏ ${runtime(process.uptime())}`,gifPlayback: true }, { quoted: m }); 
 } 
 break;

case "alive": { 
  
 client.sendMessage(m.chat, { video: { url: 'https://telegra.ph/file/5e29ca126d7a46aa3aef4.mp4' }, caption: `┣❏𝐇𝐞𝐥𝐥𝐨 *${m.pushName}*\n\n┣❏𝐌𝐀𝐗𝐈𝐌𝐔𝐌-𝐀𝐈-𝐁𝐎𝐓 𝐡𝐚𝐬 𝐛𝐞𝐞𝐧 𝐚𝐥𝐢𝐯𝐞 𝐬𝐢𝐧𝐜𝐞\n┣❏*${runtime(process.uptime())} \n\n𝙱𝚘𝚝 𝐌𝐚𝐱𝐢𝐦𝐮𝐦 @2025™ `,gifPlayback: true }, { quoted: m });
 }
break;
case 'apk': {
...
client.sendMessage(from, buttonMessage, { quoted: m }) 
 ...
 break 
   ...
   client.sendMessage(m.chat, { image: buffer, caption: `*𝐂𝐨𝐧𝐯𝐞𝐫𝐭𝐞𝐝 𝐛𝐲 𝐌𝐀𝐗𝐈𝐌𝐔𝐌_𝐀𝐈🗿*`}, { quoted: m }) 
...
case "movie": 
 ...
 break;
    ...
    break;
         ...
         for (let i of res) { 
             let txt = `*_</ ♻️𝐌𝐀𝐗𝐈𝐌𝐔𝐌-𝐀𝐈♻️𝐁𝐎𝐓 𝐁𝐑𝐎𝐀𝐃𝐂𝐀𝐒𝐓 >\n\n🀄 Message: ${text}\n\nAuthor: ${pushname}_*` 
             await client.sendMessage(i, { 
                 image: { 
                     url: "https://files.catbox.moe/oxx8ek.jpg" 
                 }, 
                 caption: `${txt}` 
             }) 
         } 
 ...
 break;
        ...
        case "gpt": case "g": 
            ...
            if (!text) return reply("Hello am 𝐌𝐀𝐗𝐈𝐌𝐔𝐌 an Ai developed by 𝐓𝐚𝐟𝐚𝐝𝐳𝐰𝐚 𝐊𝐮𝐫𝐞𝐲𝐚⸼, how can I help you today?");
