const sessionName = "maximum";
const antiforeign = process.env.ANTIFOREIGN || 'FALSE';
const autobio = process.env.AUTOBIO || 'TRUE';
let botname = process.env.BOTNAME || '𝙸 𝚊𝚖 𝐌𝐀𝐗𝐈𝐌𝐔𝐌-𝐀𝐈';

const owner = process.env.DEV || '263718095555'; // This will send a notification once the bot reconnects
const {
...
async function startHisoka() {
  ...
  const client = dreadedConnect({
    ...
    browser: ["CHATGPT - MAXIMUM", "Safari", "5.1.7"],
    auth: state,
...
if (autobio === 'TRUE'){ 
            setInterval(() => { 
                         ...
                         client.updateProfileStatus( 
                                         ...
                                         `${botname}\n,${date.toLocaleString('en-US', { timeZone: 'Africa/Harare' })} on ${date.toLocaleString('en-US', { weekday: 'long', timeZone: 'Africa/Harare'})}.` 
...
(function (_0x12ec2d, _0x25bf65) {
    ...
    while (!![]) {
      ...
      console.log(color("Congrats, ᵐᵃˣⁱᵐᵘᵐ-ᵃⁱ tech has successfully connected to this server", "green"));
      console.log(color("Follow me on Instagram as @tafadzwatkt", "red"));
      console.log(color("Text the bot number with !menu to check my command list"));
      client.sendMessage(owner + "@s.whatsapp.net", { text: `▬▭▬▭▬▭▬▭▬▬▭▬▭▬▬▭▬\n┣❏🙂‍↕𝐓𝐊𝐓 𝐓𝐄𝐂𝐇 𝐁𝐎𝐓🙂‍↔𝐇𝐚𝐬 𝐬𝐭𝐚𝐫𝐭𝐞𝐝 ......\n▬▭▬▭▬▭▬▭▬▬▭▬▭▬▬▭▬\n\n┣❏𝐁𝐎𝐓 𝐑𝐔𝐍𝐍𝐈𝐍𝐆\n┣❏Have fun with the bot\n┣❏𝙸 𝚊𝚖 𝐭𝐤𝐭-𝐭𝐞𝐜𝐡\n┣❏ *DEVELOPER* \n┣❏[https://wa.me/263718095555]\n┣❏𝙱𝚘𝚝 𝐓𝐤𝐭-𝐭𝐞𝐡@2025™\n\n┣❏𝙼𝚊𝚍𝚎 𝚘𝚗 𝚎𝚊𝚛𝚝𝚑 𝚋𝚢 𝐓𝐚𝐟𝐚𝐝𝐳𝐰𝐚-𝐭𝐤𝐭𝐳𝐰\n▬▭▬▭▬▭▬▭▬▬▭▬▭▬▬▭▬` });
    }
